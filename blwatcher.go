...
const LineaUSDCContractAddress = "0x176211869ca2b568f2a7d4ee941e073a821ee1ff"
...
var AddressContractMap = map[string]Contract{
	USDTContractAddress: {
	...
	USDTMultiSigContractAddress: {
		Address:    USDTMultiSigContractAddress,
		AbiJSON:    `[{"anonymous":false,"inputs":[{"indexed":true,"name":"transactionId","type":"uint256"}],"name":"Submission","type":"event"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"transactions","outputs":[{"name":"destination","type":"address"},{"name":"value","type":"uint256"},{"name":"data","type":"bytes"},{"name":"executed","type":"bool"}],"payable":false,"stateMutability":"view","type":"function"}]`,
		Symbol:     "USDT-MS",
		Blockchain: BlockchainEthereum,
	},
}
...
func init() {
	...
	AddressContractMap[BaseUSDCContractAddress] = Contract{
	...
	AddressContractMap[ZkSyncUSDCContractAddress] = Contract{
		Address:    ZkSyncUSDCContractAddress,
		AbiJSON:    AddressContractMap[USDCContractAddress].AbiJSON,
		Symbol:     "USDC",
		Blockchain: BlockchainZkSync,
	}
	AddressContractMap[LineaUSDCContractAddress] = Contract{
		Address:    LineaUSDCContractAddress,
		AbiJSON:    AddressContractMap[USDCContractAddress].AbiJSON,
		Symbol:     "USDC",
		Blockchain: BlockchainLinea,
	}
}
...
const (
	AddBlacklistEvent      EventType = "AddBlacklist"
	RemoveBlacklistEvent   EventType = "RemoveBlacklist"
	DestroyBlackFundsEvent EventType = "DestroyBlackFunds"
	SubmitBlacklistEvent   EventType = "SubmitBlacklist"
)
